$(document).ready(function(){ 
    ...
    $('.play_again').live('click',function(){
        var val_slot_2 = $('.slot_2 span').html();
        var rank_slot_2 = $('.slot_2 input[name=input_slot_2]').val();
        var val_slot_3 = $('.slot_3 span').html();
...
function quay_lui(number, rank, slot)
{
    var i = 0;
